        ...
        <div class="Scriptcontent">
          ...
          <form method="post">
            <div class="feedback">
              ...
              <h4>Please share your experience and give us feedback.</h4>

              <form method="post" action="#action-url">
                <label>1. Please Enter Your E-mail</label><br><br>
                <input type="email" id="email" name="user_email" placeholder="Enter Your Email" size="100px" height="20px"><br><br>
                <hr class="survey-hr">
                <label>2. Your overall experience with us ?</label><br>
                ...
                <textarea cols="75" name="fdesc" id="fdesc" rows="5"></textarea><br>
                <br>
                <div class="clear"></div>
                <input style="background:#43a7d5;color:#fff;padding:12px;border:0" name="fsubmit" id="fsubmit" type="submit" value="Submit your review">&nbsp;
              </form>
            </div>
          </form>
        </div>
...
if (isset($_POST['fsubmit'])) {
  ...
  if ($res) {
    echo "<script> alert ('Success !! Feedback is Submitted from  Thank Youu!')</script>";
