...
<body>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid bg-secondary mb-5 bg-dark">
            ...
            <div class="col-lg-8">
                <div class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label>Address</label>
                            <input class="form-control" type="text" value="<?php echo $address; ?>"  disabled>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="card border-secondary mb-5 round-0">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="text-success"><center>FREE HOME DELIVERY</center></h6>
                    </div>
