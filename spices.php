...
<body>
    ...
    <div class="container-fluid bg-dark mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height:400px">
            <h1 class="font-weight-semi-bold text-uppercase mb-2 text-white">SPICES.</h1>
                                ...
                                while($row=mysqli_fetch_assoc($res)){
                                    ...
                                    <a href ="prodetails.php?pro_id=<?php echo $row['pro_id']; ?>">
                                        <div class="card shadow">
                                            <div class="card-body">
                                            <center><img class="img-fluid width" src="assets/img/<?=$row['pro_img']?>" alt="Dry Fruits Images" style="height:35vh; width:35vh;">
                                            <h4 class="text-dark"><?= $row['pro_name']?></h4></center>
                                            </div>
                                        </div>
                                    </a>
                                </div>
<?php 
                        ...
                        $subcatquery="SELECT * FROM sub_cat WHERE cat_id = 2";
                                ...
                                while($subcatrow=mysqli_fetch_assoc($subcatres))
                                {
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <a href ="product.php?sub_cat=<?php echo $subcatrow['subcat_id']; ?>">
                                            <div class="card shadow">
                                                <div class="card-body">
                                                <center><img class="img-fluid width" src="assets/img/<?=$subcatrow['subcat_img']?>" alt="Spices Images" style="height:35vh; width:35vh;">
                                                <h4 class="text-dark"><?= $subcatrow['subcat_name']?></h4></center>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
