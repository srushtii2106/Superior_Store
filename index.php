    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1><b><i style="color:white;">Welcome to Superior Stores</i></b></h1>
        </div>
      </div>

      <div class="row gy-4 mt-5 justify-content-center text-light" data-aos="zoom-in" data-aos-delay="250">
        ...
        <!-- <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            ...
            <h3><a href="category.php" class="text-light">Top Products</a></h3>
          </div>
        </div> -->
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
