...
<div id="amc" class="container-fluid h-100 position-absolute d-flex " style="justify-content:center;align-items:center;z-index:99;background-color:#ffffff8f;">
<div class="h-25 w-25 card p-5 ">
<h5> Thank You For Shopping!</h5>
<button type="button" id="ok" onclick="hidekaro()">
    <a href="user_order.php">OK </a>
</button>
</div>
</div>
