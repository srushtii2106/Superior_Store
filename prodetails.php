                ...
                <section class="content">
                    <div class="row">
                        <div class="col-sm-9">
                            ...
                            <div class="col-sm-6">
                                <h1 class="page-header"><?php echo $Product_name; ?> </h1>
                                <h3><b><?php echo "Rs. ".$Product_price;echo "/Kg"; ?></b></h3>
                                <p><b><?php echo $Category_name; ?> : </b> <?php echo $subcat_name; ?></p>
                                <p><b>Description:</b></p>
                                <p>
                                <p><?php echo $Product_desc; ?></p>
                                </p>
                                <button name="addtocart" class="btn btn-primary btn-lg btn-curve"><i
